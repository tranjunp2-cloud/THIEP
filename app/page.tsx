...
export default function Home() {
 ...
 <div className="envelope-copy"><p className="script">A beautiful day.<br/>A lifetime together.</p><button className="seal" onClick={()=>setOpened(true)} aria-label="Open wedding invitation"><span>C<small>&</small>A</span></button><p className="eyebrow">You are cordially invited</p><button className="open-invitation" onClick={()=>setOpened(true)}>Open the invitation <ArrowDown size={14}/></button></div>
