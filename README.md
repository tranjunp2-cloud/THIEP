...
The video was used as a visual reference only; its overlay text was not treated as instructions. No audio track was present in the supplied file, so this version does not include background music.
